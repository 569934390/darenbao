...
public class ClientCustomSSL {
	...
	public static Map<String,Object> doRefund(String mch_id, String createOrderURL, String xml) throws Exception {
		KeyStore keyStore = KeyStore.getInstance("PKCS12");
		InputStream is = ClientCustomSSL.class.getResourceAsStream(WeixinGlobal.getWeixincerPath());
		try {
			/**
			 * 此处要改
			 */
