...
@Configurable
public class WeixinUserInfoDo {
	
	@Autowired
	WeixinUserInfoRepository weixinUserInfoRepository;
	...
	public void insert() {
		weixinUserInfoRepository.insert(this);
	}

	public void update() {
		weixinUserInfoRepository.update(this);
	}
}