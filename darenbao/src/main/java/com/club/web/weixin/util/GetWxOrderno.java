...
public class GetWxOrderno {
	...
	static {
		...
		// httpclient =
		// (DefaultHttpClient)HttpClientConnectionManager.getSSLInstance(httpclient);
	}
	...
	public static Map<String, Object> getPayNo(String url, String xmlParam) {
		...
		try {
			...
			dataMap = doXMLParse(jsonStr);
			if (jsonStr.indexOf("FAIL") != -1) {
				resultMap.put("code", false);
				resultMap.put("msg",dataMap.get("err_code_des")==null?dataMap.get("return_msg"):dataMap.get("err_code_des"));
				return resultMap;
			}
