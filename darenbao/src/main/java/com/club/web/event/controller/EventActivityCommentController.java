...
public class EventActivityCommentController {
	 ...
	 */
	@RequestMapping("/eventActivityCommentPage")
	@ResponseBody
	public Page<Map<String, Object>> eventActivityCommentPage(Page<Map<String, Object>> page, String conditionStr,
