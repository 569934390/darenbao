package com.club.web.finance.dao.base.po;

import java.math.BigDecimal;
import java.util.Date;

public class FinanceAccountspay {
    private Long id;
    ...
    public void setU8orderid(String u8orderid) {
        this.u8orderid = u8orderid == null ? null : u8orderid.trim();
    }
    ...
    public void setU8accountsid(String u8accountsid) {
        this.u8accountsid = u8accountsid == null ? null : u8accountsid.trim();
    }
