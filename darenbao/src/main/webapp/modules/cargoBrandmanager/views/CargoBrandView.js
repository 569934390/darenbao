define([
    'text!modules/cargoBrandmanager/templates/CargoBrandView.html',
    'modules/cargoBrandmanager/addbrandinfo/views/AddcargoBrandWindow',
    'Portal'
], function (cargoBrandViewTpl,AddcargoBrandWindow,Portal) {
	var GRID_DOM = "#cargoBrand-info-content-div";
	return club.View.extend({
        template: club.compile(cargoBrandViewTpl),
        ...
        events:{
        	"click .cargoBrand-info-main-btngroup .btn": "tbarHandler"
        },
        ...
        refresh:function(){
             ...
             $('input[name=cargoBrand-conditions]').val('');
             this.pageData(1);
        },
        //新增和修改
        add:function(action,record){
            ...
            AddcargoBrandWindow.openAddWin({
                callback:this
            },action,record);
        },
        //删除
        doDelete:function(action,records){
             ...
             var t= club.confirm('您确定要删除所选品牌吗？');
	       	 t.result.then(function resolve(){
	             $.post(Portal.webRoot+'/cargoBrand/deleteCargoBrand.do',{
        ...
        pageData :function (page, rowNum, sortname, sortorder) {
            var conditions = $('input[name=cargoBrand-conditions]').val();
            rowNum = rowNum || $(GRID_DOM).grid("getGridParam", "rowNum");
            $.post(Portal.webRoot+'/cargoBrand/cargoBrandPage.do',{
