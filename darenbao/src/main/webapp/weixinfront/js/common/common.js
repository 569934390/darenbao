...
Util.weixinMenu = {
	shareIndex:function(){
         ...
         var shareUrl = 'fromshanguo=weixinfront/html/customer/index.html'+'&storeId='+ localStorage.getItem('shopId') + '&type=weixinIndex';
         var shareTitle = localStorage.getItem('my_name');
         var shareDesc = "这么多好茶汇聚的店铺，不分享给你看看臣妾做不到啊！";
    ...
    share: function (url,shareTitle,shareUrl,shareImage,shareDesc) {
    	 var vurl = Util.common.baseUrl +"/weixin/weixinConfig/verificationUrl.do";
         var param = {"url": url};
         Util.common.executeAjaxCallback(vurl , param , function(data){
         	console.log(data);
