...
function QiniuJsSDK() {
    ...
    this.uploader = function(op) {
        ...
        plupload.extend(option, op, {
            ...
            flash_swf_url:'common/jslibs/club-desktop/third-party/js/Moxie.swf',
            silverlight_xap_url:'common/jslibs/club-desktop/third-party/js/Moxie.xap'
        });
    ...
    this.imageInfo = function(key) {
        ...
        var info;
        var that = this;
        xhr.open('GET', decodeURI(url), false);
