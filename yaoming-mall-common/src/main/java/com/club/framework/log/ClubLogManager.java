...
public final class ClubLogManager {
    ...
    public final static ConcurrentHashMap<String, ClubLogManager> loggerMap = new ConcurrentHashMap<String, ClubLogManager>();
    ...
    public static void main(String args[]) {
        ...
        ClubLogManager log = ClubLogManager
                .getLogger(ClubLogManager.class);
