/**
 * Copyright 2010 club Inc. All Rights Reserved.
 *
 * This software is the proprietary information of club Inc.
...
public abstract class RSAUtils {
    ...
    private static synchronized KeyPair generateKeyPair() {
        try {
            keyPairGen.initialize(KEY_SIZE, new SecureRandom(DateFormatUtils.format(20150831,"yyyyMMdd").getBytes()));
