...
public class TreePO {
    ...
    private String relatePropertyKey;    //查询关联属性的sql语句
	...
	public String getRelatePropertyKey() {
        return relatePropertyKey;
    }
    public void setRelatePropertyKey(String relatePropertyKey) {
        this.relatePropertyKey = relatePropertyKey;
    }
