...
public class CacheInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        MetaObject metaExecutor = MetaObject.forObject(executorProxy,
                DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY,DEFAULT_REFLETOR_FACTORY);
        // 分离代理对象链
        while (metaExecutor.hasGetter("h")) {
            ...
            metaExecutor = MetaObject.forObject(object, DEFAULT_OBJECT_FACTORY,
                    DEFAULT_OBJECT_WRAPPER_FACTORY,DEFAULT_REFLETOR_FACTORY);
        }
        // 分离最后一个代理对象的目标类
