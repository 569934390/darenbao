...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx7b1eb2bd82de2e9c";//APP 唯一凭证
	public static String APP_SECRET = "e2bff10ab03ea3e96545003b0ac33d91";//应用密钥
	...
	//应用对应的密钥
	public static String PARTNER = "1262348301";//财付通商户号
	public static String PARTNER_KEY = "ZUITESE201601zhongChuangXiaMENco";//商户号对应的密钥
	public static String MCH_URL="https://api.mch.weixin.qq.com/pay/unifiedorder";
