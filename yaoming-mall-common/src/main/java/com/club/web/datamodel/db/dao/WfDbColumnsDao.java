package com.club.web.datamodel.db.dao;


import com.club.core.common.Page;
import com.club.web.datamodel.db.arg.WfDbColumnsArg;
import com.club.web.datamodel.db.dao.mapper.IWfDbColumnsMapper;
...
@Repository(value = "FlowWfDbColumnsDao")
public class WfDbColumnsDao extends SqlSessionDaoSupport {
    ...
    public Page<WfDbColumnsPO> queryRecordByPageWithDbName(WfDbColumnsArg arg, Page<WfDbColumnsPO> resultPage) {
        List<WfDbColumnsPO> resultList = getMapper().queryRecordByPageWithDbName(arg, resultPage);
        resultPage.setResultList(resultList);
        return resultPage;
    }
    ...
    public WfDbColumnsPO selectByPrimaryKey(String key) {
