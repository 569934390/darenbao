...
//    public static final String FILE_PATH = "zuitese_cfg_file";
...
//        	config = new CompositeConfiguration();  
        	try {
        	    //先从jdk环境变量中读取"cfg_file"配置，如果没有，再去系统变量中读取
//        		String filePath =  (String) System.getProperty(FILE_PATH);
//        		if(filePath == null){
//        		    filePath =  (String) System.getenv(FILE_PATH);
//        		}
//        		if(filePath == null){
//        		    logger.error("配置文件读取异常：环境变量cfg_file未配置！");
//                }else{
//                    logger.info("文件路径"+filePath);
                    //modify by huanggy20151116
                    PropertiesConfiguration appConfiguration=new PropertiesConfiguration("config/props/appconfig.properties");
//                    PropertiesConfiguration appConfiguration=new PropertiesConfiguration(filePath+"/appconfig.properties");
