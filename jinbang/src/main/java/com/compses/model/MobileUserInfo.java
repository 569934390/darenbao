...
public class MobileUserInfo{
    ...
    private List<MobileUserInfo> firstSubordinates;

    private List<MobileUserInfo> secondSubordinates;

    private List<MobileUserInfo> thirdSubordinates;
    ...
    public List<MobileUserInfo> getFirstSubordinates() {
        return firstSubordinates;
    }

    public void setFirstSubordinates(List<MobileUserInfo> firstSubordinates) {
        this.firstSubordinates = firstSubordinates;
    }

    public List<MobileUserInfo> getSecondSubordinates() {
        return secondSubordinates;
    }

    public void setSecondSubordinates(List<MobileUserInfo> secondSubordinates) {
        this.secondSubordinates = secondSubordinates;
    }

    public List<MobileUserInfo> getThirdSubordinates() {
        return thirdSubordinates;
    }

    public void setThirdSubordinates(List<MobileUserInfo> thirdSubordinates) {
