...
public class LjSmsClient {
    protected String smsSvcUrl = "http://115.29.47.151:8860";
    protected String cust_code = "800001";
    protected String password = "CE3RCJIU7U";
...
//        System.getProperties().put("socksProxyHost", "http://115.29.47.151");
//        System.getProperties().put("socksProxyPort", "8860");
    ...
    public static void main(String[] args) {
        ...
        try {
            client.sendSms("13774666937", "sddddddd【xxxx】");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
