...
<script src="${ctx }/portal/lib/jq.js"></script>
<script type="text/javascript" src="${ctx }/privilege/DropCfg.js"></script>
<script type="text/javascript" src="${ctx }/privilege/privilegeManager.js"></script>
