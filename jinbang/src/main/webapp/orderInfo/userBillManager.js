var template = {
	...
	store:{
		fields:['recordId','userName','payUserId','receivingUserId','roleType','orderCode','tradingAmount','tradingDate','settlementDate','settlementMoney','remark','operationCategory','enterCardId','cashStatus','cashDate','balanceDate','cardDate','settlementStatus'],
