 ...
 * @field {String}
 */
AnyChart.preloaderInitText = "初始化...";//"Initializing...";
 ...
 * @field {String}
 */
AnyChart.preloaderLoadingText = "正在加载...";//"Loading... ";
 ...
 * @field {String}
 */
AnyChart.initText = "初始化...";//"Initializing...";
 ...
 * @field {String}
 */
AnyChart.xmlLoadingText = "正在加载xml...";//"Loading xml...";
 ...
 * @field {String}
 */
AnyChart.resourcesLoadingText  = "正在加载资源...";//"Loading resources...";
 ...
 * @field {String}
 */
AnyChart.noDataText = "没有数据";//"No Data";
 ...
 * @field {String}
 */
AnyChart.waitingForDataText = "正在加载数据...";//;"Waiting for data...";
 ...
 * @field {String}
 */
AnyChart.templatesLoadingText = "正在加载模板...";//"Loading templates...";
