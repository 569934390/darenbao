 ...
 * 例子:
  	var treeSelector = Ext.create('component.public.TreeSelector', {
				...
				fromTitle:'xxx',
				treePanel:Ext.create('component.business.NodeTreePanel'),
				toTitle:'xxx',
				width : 400,
				height : 400
			});
 ...
 */
Ext.define('component.public.TreeSelector', {
     ...
     */
    buttons: ['top', 'up', 'add', 'minus', 'down', 'bottom'],
    ...
    initComponent: function() {
        var me = this;
		me.store = Ext.create('Ext.data.ArrayStore', {//store没什么用只是为了保证父控件不报错
			fields : [me.displayField||'text', me.valueField||'id']
		});
        me.ddGroup = me.id + '-dd';
	...
	createTree:function(treePanel){
		var me=this;
		Ext.applyIf(treePanel,{
			title:me.fromTitle,
			name:me.fromName,
			width:'50%'
		});
//		var tree=Ext.create('Ext.panel.Panel',{width:'50%'});
		return treePanel;
	},
    ...
    setupItems: function() {
        ...
        me.fromField = me.createTree(me.treePanel);
    ...
    onAddBtnClick : function() {
        var me = this,
        selected = me.fromField.getSelectionModel().getLastSelected();
        me.moveRec(true, selected);
        me.toField.boundList.getSelectionModel().select(selected);
    },

    onMinusBtnClick : function() {
        var me = this,
