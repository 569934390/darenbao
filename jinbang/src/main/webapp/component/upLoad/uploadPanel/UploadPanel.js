...
Ext.define('Ext.ux.uploadPanel.UploadPanel',{
	...
	columns : [
		...
		}},
        {
            ...
            width:50,
            items: [{
                icon: webRoot+'component/upLoad/uploadPanel/icons/delete.gif',
                tooltip: 'Remove',
	...
	post_params : {},
	upload_url : 'test.do',
	flash_url : webRoot+"component/upLoad/swfupload/swfupload.swf",
	flash9_url : webRoot+"component/upLoad/swfupload/swfupload_fp9.swf",
