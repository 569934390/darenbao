 ...
 * 节点树形控件
 */
Ext.define('component.dcc.view.SimulatorTreePanel', {
	extend : 'component.public.TreeCommonPanel',
	alias : 'widget.simulatorTreePanel',
