Ext.define('component.business.OnuResourceWindow', {
	...
	createCmd : function() {
		...
		var cmd = {
			...
			items : [{
				...
				queryMode:'remote',
				readOnly:true,
				sqlKey:sqlmapPrefix+"ComboCommonMapper.onuResourceScriptCombo"
			},{
				xtype : 'button',
				...
				(function(record) {
					setTimeout(function() {
						if (record.get('success') == false) {
							...
							record.set('success', true);
							record.set('result', '网元Onu采集脚本执行超时！');
						}
					}, 180000);
