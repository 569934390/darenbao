Ext.define('component.business.PortListViewer', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.portListViewer',
    ...
    initComponent: function() {
    	var me = this;
    	me.columns= [
            { text: '所属网元ID', dataIndex: 'PARENT_NODE_ID',width:80,hidden:true},
            { text: '所属网元名称', dataIndex: 'PARENT_NODE_NAME',width:80},
	        { text: '端口名称', dataIndex: 'PORT_NAME',width:120},
	        { text: '网元名称', dataIndex: 'NODE_NAME',width:120},
