...
customer.search = {
    ...
    nextClassify: function (obj) {
        ...
        Util.common.executeAjaxCallback(url, param, function (data) {
            if (data == '' || data == null || $(obj).html() == "全部") {
                ...
                document.location.href = 'html/customer/search/search-result.html?title=' + $(obj).attr('title') + '&classify=' + $(obj).attr('classify') + '&type=classify';
            } else {
                var datas = data;
    ...
    getClassify: function(obj){
        ...
        customer.search.initGoodList(conditionStr);
        if($(obj).html() == "全部"){
            document.location.href = 'html/customer/search/search-result.html?title=' + secondName + '&classify=' + $(obj).attr('classify') + '&type=classify';
        }else {
            document.location.href = 'html/customer/search/search-result.html?title=' + $(obj).attr('title') + '&classify=' + $(obj).attr('classify') + '&type=classify';
        }
        $("#teaNavbarPopup").hide();
    ...
    lastClassify: function (obj) {
         ...
         Util.common.executeAjaxCallback(url, param, function(data){
             if (data == '' || data == null || $(obj).html() == "全部") {
                 ...
                 //$('#classifyId').html(firstName);
                 $('.empty-list').remove();
                 $("#teaNavbarPopup").hide();
                 customer.search.initGoodList(conditionStr);
                 if($(obj).html() == "全部"){
                     document.location.href = 'html/customer/search/search-result.html?title=' + firstName + '&classify=' + $(obj).attr('classify') + '&type=classify';
                 }else {
                     document.location.href = 'html/customer/search/search-result.html?title=' + $(obj).attr('title') + '&classify=' + $(obj).attr('classify') + '&type=classify';
                 }
             } else {
