...
//      customer.order.getToken();
    ...
    initGoodList:function(){
        ...
        Util.common.executeAjaxCallback(url, param, function (data) {
            ...
            customer.order.loadTemplate("#thelist", "#order_list_b_t_t", {datas:data});
        });
    },
...
//  },
    ...
    //提醒发货
    shipNotice: function(ids){
        var url = Util.common.baseUrl + "/weixin/indent/shipNotice.do";
        var param = {"id": ids};
        Util.common.executeAjaxCallback(url, param, function (data) {
            if(data.code === 1){
                Util.msg.show("msg", data.msg);
                this.initGoodList();
            }
        }.bind(this));
    },
